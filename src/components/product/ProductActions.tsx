...
export default function ProductActions({ product }: ProductActionsProps) {
  ...
  const buyNow = () => {
    ...
    // Create checkout data directly
    const checkoutData = {
      items: [cartItem],
      selectedCity: "",
      subtotal: cartItem.discountPrice * cartItem.quantity,
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4 pt-4">
        ...
        <button
          onClick={buyNow}
          className="w-full py-4 bg-orange-400 text-white font-medium text-sm uppercase tracking-wide hover:bg-orange-500 transition-colors"
        >
          BUY IT NOW
        </button>
      </div>
